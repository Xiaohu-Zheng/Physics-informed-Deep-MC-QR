...
from src.DeepRegression_supervised import Model
from src.mcqr.mcqr_regression import MC_QR_prediction_for_regression, Supervised_MC_QR_prediction_for_regression
    ...
    with open(file_path, 'r') as fp:
        ...
        for line in fp.readlines():
            ...
            with torch.no_grad():
                ...
                # heat_pre, std= Supervised_MC_QR_prediction_for_regression(500, u_obs, model, tau='all')
