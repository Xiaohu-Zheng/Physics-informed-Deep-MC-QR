...
class Model(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_obs = self.pointloss(heat_obs, heat_pred, taus_mat) * 1e5
    ...
    def test_step(self, batch, batch_idx):
        ...
        # heat_pred = self(heat_obs_taus)
        with torch.no_grad():
            heat_pred, _= MC_QR_prediction_for_regression(100, heat_obs, self, tau='all')

        loss_mae = self.criterion(heat_pred, heat) * self.hparams.std_heat
        return {"mae": loss_mae, "test_loss_1": loss_1, "test_loss_2": loss_2, "test_loss_3": loss_3}
